...
You can see an object's attributes with `attributes()`. If you run `attributes()` on the `deck` data frame that you created in [Project 2: Playing Cards](#sec-project-cards), you will see:
